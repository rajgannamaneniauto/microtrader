...
DOCKER_REGISTRY ?= 492764919805.dkr.ecr.ap-southeast-1.amazonaws.com
AWS_ACCOUNT_ID ?= 492764919805
DOCKER_LOGIN_EXPRESSION ?= aws ecr get-login --registry-ids 492764919805
# Release settings
